# -*- coding: utf-8 -*-
"""
Created on Fri Sep 24 11:57:47 2021
...
def main():
    ...
    description = "Phosphorylation model by Mathieu and Bob"
    ...
    # control_parameters = ['kf', 'ADP_in', 'AMP_in', 'ATP_in', 'Ade_in', 'GDP_in', 'GMP_in', 'GTP_in', 'Gua_in', 'PEP_in', 'PPi_in', 'PRPP_in', 'Pyr_in', 'UDP_in', 'UMP_in', 'UTP_in', 'Ura_in', 'APRT', 'UMPK', 'UPRT', 'AK', 'PK', 'XGPRT', 'GMPK'] #what are the control parameters
    ...
    symbols = ['-','+',')','(','*','**','|+|',"|-|","/",'\n']
    reconstructed = [('| + |','|+|'),('| - |','|-|'),("*  *","**")]
    # - GTP*kf - GTP*PK*Pyr*k_cat28_PK_GTP_Pyr/(K_M28_GTP_PK*K_M28_Pyr_PK*(1 |+| Pyr/K_M28_Pyr_PK)*(GTP/K_M28_GTP_PK |+| 1)) + GTP_in*kf 
    for i in symbols:
    ...
    modelname             = 'PhosphorylationFinalr'
    include               = []
