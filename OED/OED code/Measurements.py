...
class MeasurementObject:
    ...
    def show(self,directory = '',name = '',scale = '',store = True,show = False,temperature = False,flowrate = False):
        sns.set()
...
class GenerateExperiments:
    ...
    def return_random_pulse_measurement(self,
        ...
        """enter coordinates and simulate"""
...
#
#
#def create_distribution(a_bnd = (20,40),f_bnd = (20,40),spacing = 5):  
#        amplitudes  = numpy.linspace(a_bnd[0],a_bnd[1],spacing)
#        periodicities = numpy.linspace(f_bnd[0],f_bnd[1],spacing)
#        input_combinations = list(set(list(itertools.product(list(amplitudes),list(periodicities)))))
#        return input_combinations,periodicities,amplitudes
#
#def translate_periodicities(periodicities):
#        return {i: 2*(1./i) for i in periodicities}
#
        
#def create_oscillating_input(input_combinations,periodicities,mean = None,time = 400,timestep = 1):
#    input_potential = {}
#    periods = translate_periodicities(periodicities)
#    for i in input_combinations:
#        amplitude,period = i
#        x = numpy.arange(0,time,1)
#        y = amplitude/2*(numpy.sin(periods[period]*numpy.pi*x))
#        if mean:
#            y += mean
#        else:
#            y += amplitude
...
#
#def create_sawtooth_input(input_combinations,periodicities,mean = None,time = 400,timestep = 1):
#    input_potential = {}
#    periods = translate_periodicities(periodicities)
#    for i in input_combinations:
#        amplitude,period = i
#        x = numpy.arange(0,time,1)
#        y = amplitude/2*signal.sawtooth(periods[period]*numpy.pi*x)
#        if mean:
#            y += mean
#        else:
#            y += amplitude
...
#    return input_potential
# 
#def create_binary_input(input_combinations,periodicities,mean = None,time = 400,timestep = 1):
#    input_potential = {}
#    periods = translate_periodicities(periodicities)
#    for i in input_combinations:
#        amplitude,period = i
#        x = numpy.arange(0,time,1   )
#        y = amplitude/2*signal.square(periods[period]*numpy.pi*x)
#        if mean:
#            y += mean
#        else:
#            y += amplitude
...
#    return
#
#def proportional_binary_input(periodicities = (50,100),samples = 10, boundaries = (0,1),time = 400):
#    proportional_input = {}
...
#         proportional_input[period] = y
#    return proportional_input
#
#def proportional_oscillating_input(periodicities = (50,100),samples = 10, boundaries = (0,1),time = 400):
#    proportional_input = {}
#    minimum,maximum = periodicities
#    periods = translate_periodicities(numpy.linspace(minimum,maximum,samples))
#    t = numpy.arange(0,time,1)
...
#    return proportional_input
#
#def proportional_sawtooth_input(periodicities = (50,100),samples = 10, boundaries = (0,1),time = 400):
#    proportional_input = {}
#    minimum,maximum = periodicities
#    periods = translate_periodicities(numpy.linspace(minimum,maximum,samples))
#    t = numpy.arange(0,time,1)
...
#    return proportional_input
#
#input_combinations,periodicities,amplitudes = create_distribution()    
#data = create_oscillating_input(input_combinations,periodicities,mean = None,time = 400,timestep = 1)   
#plot_input_database(data) 
#data = create_sawtooth_input(input_combinations,periodicities,mean = None,time = 400,timestep = 1)
#plot_input_database(data)
#data = create_binary_input(input_combinations,periodicities,mean = None,time = 400,timestep = 1)
#plot_input_database(data)
#data = proportional_binary_input()
#plot_input_database(data)
#data = proportional_oscillating_input()
#plot_input_database(data)
#data = proportional_sawtooth_input()
#plot_input_database(data)
        
        

#    def measurement_simulation(self,):
#        """maximized conditions and corresponding measurement objects"""
#        self.maximized_conditions = {}
#        for observables,values in self.distance_set.items():
#            for i in values:
#                self.maximized_conditions[len(self.maximized_conditions)] = self.measurements[i]
#        return self.maximized_conditions 
#    
#        if show:
#            for observable,indices in self.distance_set.items():
#                for i in indices:
#                    plt.plot(data[observable][i])
#                plt.xlabel("Time")
#                plt.ylabel("Concentration")
#                plt.title("Maximized Information Experiments: {}".format(observable))
#                plt.yscale("log")
#                plt.show()
#                
#            colors = {i: numpy.random.rand(3,) for i in model.observables}
#            """plot superset measurements"""
#            for i in self.measurement_superset:
#                """label bool"""
#                index = False
#                for measurement in i:
#                    for observable,profile in measurement.profile.items():
#                        """set index"""
#                        if observable in model.observables:
#                            plt.plot(profile,c = colors[observable])
#                            if not index:
#                                """plot legend"""
#                                plt.plot(profile,c = colors[observable],label = observable)
#                    """alter bool"""
#                    index = True
#                """"plot legend"""
#                plt.legend(fancybox = True)   
