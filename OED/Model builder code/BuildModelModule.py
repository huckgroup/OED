...
class ReactionKinetics:
    ...
    def kinetic_GH(self,):
        ...
        if len(self.reactants) > 1 and self.enzyme != False:  
            ...
            GH_denominator = ' ( ( {0} * {1} ){2} |+| ( {3} * {4} ) |+| ( {5} * {6} ) |+| ( {7} * {8} ) ) '.format(km1,km2,self.a_inh,km2,S1,km1,S2,S1,S2)
    ...
    def kinetic_EO(self,order = ()):
        ...
        if len(self.reactants) > 1 and self.enzyme != False:  
            ...
            EO_denominator = ' ( ( {0} * {1} ){2} |+| ( {3} * {4} ) |+| ( {5} * {6} ) ) '.format(kai,kb,self.a_inh,kb,S1,S1,S2)
    ...
    def kinetic_PP(self,):
        ...
        if len(self.reactants) > 1 and self.enzyme != False:  
            ...
            PP_denominator =  ' ( ( {0} * {1} ){2} |+| ( {3} * {4} ) |+|  ( {5} * {6} ) ) '.format(kb,S1,self.a_inh,ka,S2,S1,S2)
    ...
    def kinetic_RER(self,):
        ...
        if len(self.reactants) > 1 and self.enzyme != False:  
            ...
            RER_denominator =  ' ( ( {0} * {1} ){2} |+| ( {3} * {4} ) |+| ( {5} * {6} ) |+| ( {7} * {8} ) ) '.format(kai,kb,self.a_inh,kb,S1,ka,S2,S1,S2)
